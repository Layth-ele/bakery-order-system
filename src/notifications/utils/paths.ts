/**
 * 🛣️ Notification Paths Utility
 * 
 * ✅ DOMAIN UTILITY: Canonical notification paths
 * ✅ MIGRATED: March 7, 2026 from /utils/notification-paths.ts
 * 
 * PURPOSE:
 * - Single source of truth for Firestore notification paths
 * - Prevents path mismatches that cause notifications to go missing
 * - Consistent path format across the application
 * 
 * ARCHITECTURE:
 * - Domain utilities live here in /notifications/utils/
 * - Used by both domain logic and persistence layer
 * 
 * VERSION: 1.1.0 - Migrated to /notifications/utils/
 ...
 * import { getCustomerNotificationPath, getAdminNotificationPath } from '@/notifications';
 * 
